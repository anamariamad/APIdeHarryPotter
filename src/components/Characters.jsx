...
return (
        ...
        <div className="contenedor">               
                <div className='card' key={character.id}>
                        ...
                        <p>Nombre en la pelicula: <strong> {character.name}</strong> </p>
                        <p>Nombre actor: <strong> {character.actor} </strong> </p>
                        <p>Genero: <strong> {character.gender} </strong></p>
                        <p>Especie: <strong> {character.species} </strong> </p>
                        <br/> 
                        <button onClick={openDetailsPopUp} className='button-card-style'> Ver mas detalles </button>
                </div>
